...
#define OV2640_VSYNC PBin(7) // VSYNC控制信号
#define OV2640_HREF PAin(4)  // HREF信号
#define OV2640_PCLK PAin(6)  // PCLK信号
...
#define jpeg_dma_bufsize 2 * 1024 // 定义JPEG DMA接收时数据缓存jpeg_buf0/1的大小(*4字节)
