...
uint8_t ov2640_init(void)
{
	...
	// 其它引脚初始化
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_4 | GPIO_Pin_6; // PA4 PA6
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_6 | GPIO_Pin_7 | GPIO_Pin_8 | GPIO_Pin_9 | GPIO_Pin_11; // PC6~PC9 PC11
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IN;												   // 输入模式
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_100MHz;											   // 100MHz
	GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_UP;												   // 上拉
...
// 设置图像开窗大小
// 由:ov2640_image_size_set确定传感器输出分辨率从大小.
